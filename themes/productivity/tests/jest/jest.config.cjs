/**
 * Jest Configuration for Productivity Theme
 *
...
// In monorepo: themes/productivity/tests/jest -> apps/dev (via symlink in contents/)
// In npm mode: contents/themes/productivity/tests/jest -> project root (5 levels up)
...
module.exports = {
  displayName: 'theme-productivity',
  rootDir: projectRoot,

/**
 * Jest Configuration for Blog Theme
 *
...
// In monorepo: themes/blog/tests/jest -> apps/dev (via symlink in contents/)
// In npm mode: contents/themes/blog/tests/jest -> project root (5 levels up)

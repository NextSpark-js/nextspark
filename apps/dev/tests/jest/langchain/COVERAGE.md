...
**Test Location:** `tests/jest/langchain/`
**Source Location:** `plugins/langchain/lib/`
...
**Source:** `plugins/langchain/lib/guardrails.ts`
...
**Source:** `plugins/langchain/lib/token-tracker.ts`
...
**Source:** `plugins/langchain/lib/streaming.ts`
...
**Covered by:** Cypress E2E tests in `tests/cypress/e2e/ai/`
...
pnpm --dir apps/dev exec jest --watchman=false -- --testPathPattern=langchain

# Run specific test file
pnpm --dir apps/dev exec jest --watchman=false -- tests/jest/langchain/guardrails.test.ts

# Run with coverage
pnpm --dir apps/dev exec jest --watchman=false -- --coverage --testPathPattern=langchain
```
...
```
PASS  tests/jest/langchain/guardrails.test.ts
PASS  tests/jest/langchain/token-tracker.test.ts
PASS  tests/jest/langchain/streaming.test.ts

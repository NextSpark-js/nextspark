...
| POM | File | Usage |
|-----|------|-------|
| PageBuilderPOM | `tests/cypress/src/features/PageBuilderPOM.ts` | Block editor selectors and methods |
| PagesPOM | `tests/cypress/src/entities/PagesPOM.ts` | Pages entity selectors |

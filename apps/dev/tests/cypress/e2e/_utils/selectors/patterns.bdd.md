...
| POM | File | Usage |
|-----|------|-------|
| PatternsPOM | `tests/cypress/src/entities/PatternsPOM.ts` | List operations, entity selectors |
| PageBuilderPOM | `tests/cypress/src/features/PageBuilderPOM.ts` | Editor selectors |

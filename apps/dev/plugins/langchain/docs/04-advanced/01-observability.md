...
```typescript
import { useTraces } from '@/plugins/langchain/hooks/observability'
...
```typescript
import { useTraceDetail } from '@/plugins/langchain/hooks/observability'
...
```typescript
import { useMetrics } from '@/plugins/langchain/hooks/observability'

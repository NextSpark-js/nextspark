...
export default function AcceptInvitePage() {
  ...
  if (authLoading || status === 'loading') {
    return (
      <div className="flex flex-col items-center py-6" data-cy={createCyId('accept-invite', 'loading')}>
  ...
  return (
    <div className="space-y-6" data-cy={createCyId('accept-invite', 'container')}>
      {/* Header with icon */}
      <div className="text-center" data-cy={createCyId('accept-invite', 'info')}>
      ...
      {/* Accepted */}
      {status === 'accepted' && (
        <Alert className="border-green-200 bg-green-50 dark:bg-green-950/20 dark:border-green-900" data-cy={createCyId('accept-invite', 'success')}>
      ...
      {status === 'already_member' && (
        <Alert className="border-blue-200 bg-blue-50 dark:bg-blue-950/20 dark:border-blue-900" data-cy={createCyId('accept-invite', 'already-member')}>

...
```typescript
import { useTraces } from '@nextsparkjs/plugin-langchain/hooks/observability'
...
```typescript
import { useTraceDetail } from '@nextsparkjs/plugin-langchain/hooks/observability'
...
```typescript
import { useMetrics } from '@nextsparkjs/plugin-langchain/hooks/observability'

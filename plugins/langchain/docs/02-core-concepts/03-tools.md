...
import type { ToolDefinition } from '@nextsparkjs/plugin-langchain/lib/tools-builder'
...
```typescript
import { buildTools, type ToolDefinition } from '@nextsparkjs/plugin-langchain/lib/tools-builder'

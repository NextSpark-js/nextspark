...
# =============================================================================
# NPM Package Test Runner Script
# =============================================================================
# Runs tests in the npm test project created by setup.sh.
#
# Usage:
#   ./run.sh [OPTIONS]
#
...
print_header() {
  echo ""
  echo -e "${CYAN}========================================${NC}"
  echo -e "${CYAN}  NextSpark - NPM Package Test Runner${NC}"
  echo -e "${CYAN}========================================${NC}"
  echo ""
}
...
if [ ! -d "$PROJECT_PATH" ]; then
  ...
  echo "  ./scripts/tests/npm/setup.sh"
  exit 1
fi

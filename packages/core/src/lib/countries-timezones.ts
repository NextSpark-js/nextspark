...
export const timezones = [
  ...
  { value: 'US/Alaska', label: '(UTC-09:00) Alaska' },
  { value: 'US/Pacific', label: '(UTC-08:00) Pacific Time (US & Canada)' },
  { value: 'America/Tijuana', label: '(UTC-08:00) Tijuana, Baja California' },
  { value: 'US/Arizona', label: '(UTC-07:00) Arizona' },
  { value: 'US/Mountain', label: '(UTC-07:00) Mountain Time (US & Canada)' },
  { value: 'America/Chihuahua', label: '(UTC-07:00) Chihuahua, La Paz, Mazatlan' },
  { value: 'US/Central', label: '(UTC-06:00) Central Time (US & Canada)' },
  { value: 'America/Mexico_City', label: '(UTC-06:00) Guadalajara, Mexico City, Monterrey' },
  { value: 'Canada/Saskatchewan', label: '(UTC-06:00) Saskatchewan' },
  { value: 'America/Bogota', label: '(UTC-05:00) Bogota, Lima, Quito, Rio Branco' },
  { value: 'US/Eastern', label: '(UTC-05:00) Eastern Time (US & Canada)' },
  { value: 'US/East-Indiana', label: '(UTC-05:00) Indiana (East)' },
  { value: 'Canada/Atlantic', label: '(UTC-04:00) Atlantic Time (Canada)' },
  ...
  { value: 'Canada/Newfoundland', label: '(UTC-03:30) Newfoundland' },
  ...
  { value: 'Etc/Greenwich', label: '(UTC+00:00) Greenwich Mean Time : Dublin, Edinburgh, Lisbon, London' },
  ...
  { value: 'Asia/Colombo', label: '(UTC+05:30) Sri Jayawardenapura' },

/**
 * Pattern Usages Route Handlers Factory
 *
 * Creates compiled route handlers for pattern usages API.
 * Use this factory in your app's route file:
 *
 * @example
 * // app/api/v1/patterns/[id]/usages/route.ts
 * import { createPatternUsagesHandlers } from '@nextsparkjs/core/lib/api/routes'
 * export const { GET, OPTIONS } = createPatternUsagesHandlers()
 */
...
/**
 * Creates GET and OPTIONS handlers for pattern usages endpoint
 *
 ...
 */
export function createPatternUsagesHandlers() {

 ...
 */
export type EntityAction = 'create' | 'read' | 'list' | 'update' | 'delete' | 'export' | 'import' | 'assign' | 'publish' | 'archive';
/**
 ...
 */
export type ActionDeniedReason = 'not_member' | 'permission_denied' | 'feature_disabled' | 'quota_exceeded' | 'subscription_inactive';
/**

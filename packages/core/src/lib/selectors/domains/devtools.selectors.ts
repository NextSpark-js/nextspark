...
export const DEVTOOLS_SELECTORS = {
  ...
  scheduledActions: {
    ...
    cellAttempts: 'scheduled-actions-cell-attempts',
    cellScheduledAt: 'scheduled-actions-cell-scheduled-at',
    cellStartedAt: 'scheduled-actions-cell-started-at',
    cellCompletedAt: 'scheduled-actions-cell-completed-at',
    ...
    runBtn: 'scheduled-actions-run-btn-{id}',

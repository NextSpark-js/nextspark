...
import { EntityBulkActions } from '../../entities/EntityBulkActions'
...
import { PatternDeleteDialog } from '../PatternDeleteDialog'
...
import type { QuickAction, DropdownAction } from '../../entities/entity-table.types'

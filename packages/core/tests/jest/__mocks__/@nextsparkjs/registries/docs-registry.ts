  ...
  pages: [
    {
      ...
      title: 'Introduction',
      order: 1,
      path: 'docs/public/01-getting-started/01-introduction.md',
      source: 'public',
    },
    {
      slug: 'installation',
      title: 'Installation',
      order: 2,
      path: 'docs/public/01-getting-started/02-installation.md',
      source: 'public',
    },
  ],
}
  ...
  pages: [
    {
      ...
      title: 'Components',
      order: 1,
      path: 'docs/public/02-features/01-components.md',
      source: 'public',
    },
    {
      slug: 'styling',
      title: 'Styling',
      order: 2,
      path: 'docs/public/02-features/02-styling.md',
      source: 'public',
    },
  ],
}
  ...
  pages: [
    {
      ...
      title: 'Configuration',
      order: 1,
      path: 'docs/superadmin/01-setup/01-configuration.md',
      source: 'superadmin',
    },
    {
      slug: 'deployment',
      title: 'Deployment',
      order: 2,
      path: 'docs/superadmin/01-setup/02-deployment.md',
      source: 'superadmin',
    },
  ],
}
  ...
  pages: [
    {
      ...
      order: 1,
      path: 'docs/superadmin/02-management/01-users.md',
      source: 'superadmin',
    },
  ],
}

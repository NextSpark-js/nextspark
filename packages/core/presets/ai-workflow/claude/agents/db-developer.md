...
VALUES
  ...
  ('55555555-5555-5555-5555-555555555555', 'Cypress Super Admin', 'superadmin@nextspark.dev', true,
...
### Paso 2: Determinar Requerimientos
...
### Paso 4: Actualizar Archivos de Sesión
...
**Trabajo Realizado:**
- Creada migración: `migrations/0XX_feature.sql`
- Creada sample data: `migrations/0XX_feature_sample.sql`
- Test users configurados con password hash estándar
- devKeyring configurado en app.config.ts
- Total: XX registros de sample data creados

**Detalles Técnicos:**
- Tablas: tableName1, tableName2
- Índices: idx_table_userId, idx_table_teamId
- Foreign keys: Todas con ON DELETE CASCADE

**Próximo Paso:** Ejecutar db-validator para verificar migrations
```

...
/**
 * Tasks CRUD - Owner Role (Full Access)
 *
 * EXAMPLE FILE - This demonstrates how to write UAT tests for a dashboard entity.
 * Copy and adapt this file for your own entities.
 *
 * Location: _examples/tasks/tasks-owner.cy.ts
 */

import * as allure from 'allure-cypress'

// In real tests, import from src/components/
// import { TasksPOM } from '../../src/components/TasksPOM'
import { TasksPOM } from './TasksPOM'
...
describe('Tasks CRUD - Owner Role (Full Access)', () => {
  ...
  describe('CREATE - Owner can create tasks', () => {
    it('OWNER_TASK_CREATE_001: should create new task successfully', () => {
  ...
  describe('READ - Owner can read tasks', () => {
    it('OWNER_TASK_READ_001: should view task list', () => {
      allure.severity('critical')

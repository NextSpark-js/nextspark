...
import { postHtmlHasUnsafeMarkup, sanitizePostHtml } from '@/lib/sanitize-post-html'
import {
  Bold,
  Italic,
  Underline,
    ...
    <div className={cn('rounded-lg border border-input bg-background', className)} data-cy="wysiwyg-container">
      ...
      {isPreview ? (
        <div
          ...
          style={{ minHeight }}
          dangerouslySetInnerHTML={{ __html: sanitizePostHtml(value || '<p class="text-muted-foreground">Nothing to preview...</p>') }}

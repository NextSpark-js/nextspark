...
Blog theme POM classes are located at `test/cypress/src/classes/`:
...
npx cypress run --spec "test/cypress/e2e/**/*.cy.ts"

# Run only posts tests
npx cypress run --spec "test/cypress/e2e/posts/**/*.cy.ts"

# Run only categories tests
npx cypress run --spec "test/cypress/e2e/categories/**/*.cy.ts"

...
-- Description: Tasks (table, indexes, RLS) - Starter Theme
-- Date: 2025-01-03
...
-- The access.shared logic (user isolation) is handled at APP LEVEL
-- This allows changing the behavior from config without modifying RLS

...
| POM | File | Usage |
|-----|------|-------|
| SettingsPOM | `tests/cypress/src/features/SettingsPOM.ts` | Teams settings page selectors |
| TeamSwitcherPOM | `tests/cypress/src/components/TeamSwitcherPOM.ts` | Create team dialog selectors |

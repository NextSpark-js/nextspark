...
| POM | File | Usage |
|-----|------|-------|
| TasksPOM | `tests/cypress/src/entities/TasksPOM.ts` | Entity-specific selectors and methods |
| DashboardEntityPOM | `tests/cypress/src/core/DashboardEntityPOM.ts` | Base entity POM with dynamic selectors |

      ...
      <CardContent>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div className="space-y-2">
            ...
            <PasswordInput
              ...
              password={password || ""}
              data-cy={sel('auth.resetPassword.password')}
            />
            {errors.password && (
          ...
          <div className="space-y-2">
            ...
            <PasswordInput
              ...
              data-cy={sel('auth.resetPassword.confirmPassword')}
            />
          ...
          <Button
            ...
            className="w-full"
            data-cy={sel('auth.resetPassword.submitButton')}
          >
            {loading ? (
              <>
        ...
        <div className="text-center mt-4">
          <Link
            ...
            data-cy={sel('auth.resetPassword.backToLogin')}
          >
            Back to Login
          </Link>
        </div>

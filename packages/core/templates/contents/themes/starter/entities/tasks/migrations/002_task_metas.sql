-- Migration: 002_task_metas.sql
-- Description: Tasks metas (table, indexes, RLS) - Starter Theme
-- Date: 2025-01-03
...
-- ============================
-- Inherits isolation from parent task via teamId
-- The access.shared logic is handled at APP LEVEL

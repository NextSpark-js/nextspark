 ...
 * uses. This means consumer-defined slugs (in root-level `emails/`) get
 ...
 * Override behaviour: drop a file at \`emails/<slug>.ts\` and rebuild — the
 * project version wins over the core default at the same slug, and entirely
 * new project slugs are additive.
 *

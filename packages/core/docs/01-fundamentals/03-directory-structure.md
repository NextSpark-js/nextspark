...
```text
scripts/
├── packages/core/scripts/build/registry.mjs       # Registry generation, docs included (CRITICAL)
...
**Key Scripts:**
- `packages/core/scripts/build/registry.mjs` - Generates all registries (~17,255x perf improvement)
...
### `core/lib/registries/`
Auto-generated by `packages/core/scripts/build/registry.mjs` - contains all registries.

### `public/theme/`
Theme assets served by the app. In the monorepo this directory is `apps/dev/public/theme/`; it is not regenerated by `pnpm dev`.

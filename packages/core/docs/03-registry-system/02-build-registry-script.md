...
**Script location:** `packages/core/scripts/build/registry.mjs` (entry point, 270 lines)
...
```bash
# In the NextSpark monorepo, from the repository root: one-time build
cd apps/dev && node ../../packages/core/scripts/build/registry.mjs

# In the NextSpark monorepo, from the repository root: watch mode
cd apps/dev && node ../../packages/core/scripts/build/registry.mjs --watch

# In the NextSpark monorepo, from the repository root: explicit build mode
cd apps/dev && node ../../packages/core/scripts/build/registry.mjs --build

# In the NextSpark monorepo, from the repository root: verbose logging
...
# In a generated project, from the project root: one-time build
pnpm build:registries

# In a generated project, from the project root: watch mode
 ...
 *
 * DO NOT EDIT - This file is auto-generated by packages/core/scripts/build/registry.mjs
 */

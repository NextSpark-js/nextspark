...
The Theme Registry (`core/lib/registries/theme-registry.ts`) provides **ultra-fast, zero-I/O access** to theme configurations, assets, and metadata. It's auto-generated by `packages/core/scripts/build/registry.mjs` and enables instant theme switching without runtime filesystem access.
...
**Build script** (`packages/core/scripts/build/registry.mjs`) automatically discovers:

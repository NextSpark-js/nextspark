...
The **Config Registry** (`.nextspark/registries/config-registry.ts`) is an auto-generated registry designed for **discovering and centralizing configuration files** across themes and plugins.
...
**Location:** `.nextspark/registries/config-registry.ts`
**Auto-regenerates:** When project or enabled-plugin config files change
...
**Example:**
```typescript
import { getRegisteredConfigs } from '@nextsparkjs/registries/config-registry'
...
**Example:**
```typescript
import { getConfig } from '@nextsparkjs/registries/config-registry'
...
import { getRegisteredConfigs, CONFIG_METADATA } from '@nextsparkjs/registries/config-registry'
...
import {
  ...
  getRegisteredConfigs,
  CONFIG_METADATA
} from '@nextsparkjs/registries/config-registry'
...
ls config/feature-flags.config.ts
...
import type { MyConfig } from '@/config/my.config'
...
**Build Script:** `packages/core/scripts/build/registry.mjs` (lines 2835-2894)

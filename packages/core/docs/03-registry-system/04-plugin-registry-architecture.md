...
**Auto-regenerates:** When plugin files change in `plugins/*/`
...
**Location:** `.nextspark/registries/plugin-registry.ts`
...
**Location:** `.nextspark/registries/plugin-registry.client.ts`
...
export const PLUGIN_REGISTRY: ClientPluginRegistry = {
  'ai': {
    ...
    apiPath: '@/plugins/ai/api', // ⚠️ Path only, no route handlers
...
|----------|----------|--------|
| **Server Component** | Server | `@nextsparkjs/registries/plugin-registry` |
| **API Route** | Server | `@nextsparkjs/registries/plugin-registry` |
| **Server Action** | Server | `@nextsparkjs/registries/plugin-registry` |
| **Client Component** | Client | `@nextsparkjs/registries/plugin-registry.client` |
| **Browser Code** | Client | `@nextsparkjs/registries/plugin-registry.client` |
    ...
    entities: [
      {
        ...
        configPath: '@/plugins/ai/entities/ai-history/ai-history.config',
        depth: 0,
        parent: null,
        children: [],
        hasComponents: false,
...
**Example:**
```typescript
import { getAllPluginEntities } from '@nextsparkjs/registries/plugin-registry'
...
import { getPlugin, usePlugin, getPluginFunctions } from '@nextsparkjs/registries/plugin-registry'
...
import { getPlugin, getAllPlugins, hasPlugin } from '@nextsparkjs/registries/plugin-registry.client'
...
**Client Source:** `.nextspark/registries/plugin-registry.client.ts` (auto-generated)
**Build Script:** `packages/core/scripts/build/registry.mjs` (lines 1300-1842)

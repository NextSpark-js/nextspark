...
**Auto-Generated Registry**: `.nextspark/registries/translation-registry.ts`

The translation registry is generated by `packages/core/scripts/build/registry.mjs` and provides:
...
import themeMessages from '@/messages/en.json'
```
...
plugins/[plugin]/messages/en.json
plugins/[plugin]/messages/es.json
```

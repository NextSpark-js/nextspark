 ...
 * This allows the project to compile before running registry:build
 */
async function generateInitialRegistries(): Promise<void> {
  const projectRoot = process.cwd()
  const registriesDir = path.join(projectRoot, '.nextspark', 'registries')

  // Create directory if it doesn't exist
  await fs.ensureDir(registriesDir)

  // Block Registry
  await fs.writeFile(path.join(registriesDir, 'block-registry.ts'), `// Auto-generated by nextspark init
...
`)
  ...
  // Theme Registry
  await fs.writeFile(path.join(registriesDir, 'theme-registry.ts'), `// Auto-generated by nextspark init
export const THEME_REGISTRY: Record<string, unknown> = {}
`)

  // Entity Registry
  await fs.writeFile(path.join(registriesDir, 'entity-registry.ts'), `// Auto-generated by nextspark init
export const ENTITY_REGISTRY: Record<string, unknown> = {}
`)

  await fs.writeFile(path.join(registriesDir, 'entity-registry.client.ts'), `// Auto-generated by nextspark init
...
`)
  ...
  // Billing Registry
  await fs.writeFile(path.join(registriesDir, 'billing-registry.ts'), `// Auto-generated by nextspark init
export const BILLING_REGISTRY = { plans: [], features: [] }
`)

  // Plugin Registry
  await fs.writeFile(path.join(registriesDir, 'plugin-registry.ts'), `// Auto-generated by nextspark init
export const PLUGIN_REGISTRY: Record<string, unknown> = {}
`)

  // Testing Registry
  await fs.writeFile(path.join(registriesDir, 'testing-registry.ts'), `// Auto-generated by nextspark init
...
`)
  ...
  // Docs Registry
  await fs.writeFile(path.join(registriesDir, 'docs-registry.ts'), `// Auto-generated by nextspark init
export const DOCS_REGISTRY = { sections: [], pages: [] }
export type DocSectionMeta = { title: string; slug: string }
`)

  // Index
  await fs.writeFile(path.join(registriesDir, 'index.ts'), `// Auto-generated by nextspark init
